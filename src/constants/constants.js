export const projects = [
  ...
  },
  {
    ...
    visit: 'https://github.com/gourab99-tech/crypto-app.git',
    id: 1,
  },
  {
    title: 'FetchUp',
    description: "It is a replica on Google Search. Switch between Dark Mode and Light Mode is also available. The styling is done by using Tailwind CSS which made the design reponsive and efficient.",
    image: '/images/b.png',
    tags: ['React', 'Tailwind CSS'],
    visit: 'https://github.com/gourab99-tech/fetchup.git',
    source: 'https://fetchup.netlify.app',
    id: 2,
  },
];
